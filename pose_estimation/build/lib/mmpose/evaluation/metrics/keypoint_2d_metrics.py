...
class PCKAccuracy(BaseMetric):
    ...
    def process(self, data_batch: Sequence[dict],
        ...
        for data_sample in data_samples:
            ...
            result = {
                ...
                'gt_coords': gt_coords,
                'mask': mask,
                'keypoints_visible':data_sample['gt_instances']['keypoints_visible'],
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        # import pdb
        # import json
        # print("as",results,"pkl",len(results))
        # results_new=[]
        # for res in results:
        #     temp={}
        #     temp['img_path'] = res['img_path']
        #     temp['pred_coords']=res['pred_coords'].tolist()
        #     temp['keypoints_visible']=res['keypoints_visible'].tolist()
        #     results_new.append(temp)
        # # print(results_new,"kljl",len(results_new))
        # with open("/mnt/petrelfs/zhanghao1/mmpose/data/lvlmdata/animal_ak/animal_ak_lvlm_evaluate.json", "w") as f:
...
class MpiiPCKAccuracy(PCKAccuracy):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        #     results_new.append(temp)
        # # print(results_new,"kljl",len(results_new))
        # with open("/mnt/petrelfs/zhanghao1/mmpose/data/lvlmdata/clothes_deepfashion/deepfashion_lvlm_evaluate.json", "w") as f:
        #     json.dump(results_new, f, indent=4)
        # pdb.set_trace()
        #.tolist()
