...
##srun --partition=Gveval3 --quotatype=spot --mpi=pmi2 --time=5-00:00:00 --gres=gpu:1 python tools/analysis_tools/get_flops.py configs/hrvmamba/mamba_vision_160k_ade20k-512x512_base.py
